...
public class ExceptionPercentMeteredTest {
    private InstrumentedWithExceptionPercentMetered instance;
    ...
    public void setup() {
        ...
        this.instance = injector.getInstance(InstrumentedWithExceptionPercentMetered.class);
    }

    @Test
    public void anExceptionMeteredAnnotatedMethodWithPublicScope() throws Exception {

        final Meter metrice = registry.getMeters().get(name(InstrumentedWithExceptionPercentMetered.class, "exceptionCounter-exceptions"));
        final Meter metrict = registry.getMeters().get(name(InstrumentedWithExceptionPercentMetered.class, "exceptionCounter-total"));
        final Gauge gauge = registry.getGauges().get(name(InstrumentedWithExceptionPercentMetered.class, "exceptionCounter-exceptions_percentage"));
        assertMetricIsSetup(metrice);
        assertMetricIsSetup(metrict);
        assertGaugeIsSetup(gauge);
        ...
        assertThat("Gauge is calculated",
    ...
    private void assertGaugeIsSetup(final Gauge gauge) {
